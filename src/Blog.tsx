...
const posts = [
  {
    ...
    excerpt: "The best interfaces are the ones users never think about. We explore the craft behind invisible UX and why restraint is the hardest skill to master.",
    category: "Design",
    date: "April 10, 2026",
    readTime: "5 min read",
    featured: true,
  ...
  {
    id: 2,
    title: "The Cost of Hidden Complexity",
    excerpt: "Every shortcut in architecture compounds. Here's how we audit systems for invisible debt before it becomes a production emergency.",
  ...
  },
  {
    ...
    excerpt: "Technical mastery alone isn't enough. The products that endure are built by teams who understand what people actually need — not what they say they want.",
    category: "Product",
    date: "March 14, 2026",
    readTime: "4 min read",
    featured: false,
  ...
  {
    id: 4,
    title: "Why Software Fails at the Last Mile",
    excerpt: "Most failures don't happen in the core logic. They happen at the edges — in the handoff between system and human. We've learned to obsess over that gap.",
    category: "Engineering",
  ...
  {
    id: 5,
    title: "Quiet Beauty in System Design",
    excerpt: "There's an aesthetic to well-designed systems that only engineers notice. We believe that beauty at the architecture level eventually surfaces to the user.",
    category: "Philosophy",
  ...
  {
    id: 6,
    title: "The Path from Thought to Form",
    excerpt: "How we take an abstract brief and turn it into something tangible — the internal process we've refined over dozens of projects.",
    category: "Process",
...
const categoryColors: Record<string, string> = {
  Design: "bg-surface-container-high text-secondary",
  Engineering: "bg-surface-container-high text-secondary",
  Product: "bg-surface-container-high text-secondary",
  Philosophy: "bg-surface-container-high text-secondary",
  Process: "bg-surface-container-high text-secondary",
};
...
const PostCard = ({ post, index }: { post: typeof posts[0]; index: number }) => (
  <motion.div
    ...
    className="group cursor-pointer border border-outline-variant/20 rounded-2xl p-8 hover:border-outline-variant/50 hover:bg-surface-container-low transition-all duration-300 flex flex-col justify-between gap-6"
  >
    <div>
      <div className="flex items-center justify-between mb-5">
        <span className={`text-xs font-medium uppercase tracking-widest rounded-full px-3 py-1 ${categoryColors[post.category]}`}>
          {post.category}
        </span>
