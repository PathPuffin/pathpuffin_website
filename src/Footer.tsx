  ...
  return (
    <footer className="w-full py-16 bg-primary text-on-primary">
      <div className="max-w-7xl mx-auto px-8">
        ...
        {/* Main row */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-12 pb-12 border-b border-white/10">
            ...
            {subscribed ? (
              ...
              <form className="flex gap-3 max-w-sm" onSubmit={handleSubscribe}>
                <input
                  ...
                  className="bg-transparent border-b border-white/30 py-2 px-1 focus:outline-none focus:border-white/60 transition-colors text-sm placeholder:text-white/40 w-28"
                />
                <input
                  type="email"
                  placeholder="Email"
                  ...
                  required
                  className="bg-transparent border-b border-white/30 py-2 px-1 focus:outline-none focus:border-white/60 transition-colors flex-1 text-sm placeholder:text-white/40"
                />
                <button
                  type="submit"
                  className="bg-white text-primary px-5 py-1.5 rounded-md font-medium text-sm hover:bg-white/90 transition-colors whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
